...
struct wp_args_math_0065_3988506f {
...
void math_0065_3988506f_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_math_0065_3988506f *_wp_args)
{
    //---------
    // argument vars
    ...
    wp::float32 var_2;
    wp::float32 var_3;
    const wp::float32 var_4 = 3.14159;
    wp::float32 var_5;
    wp::float32 var_6;
    //---------
    // forward
    // def math_0065(data: wp.array(dtype=float),                                             <L 4>
    // i = wp.tid()                                                                           <L 7>
    var_0 = builtin_tid1d();
    ...
    // output[i] = wp.sin(val * 3.14159)                                                      <L 9>
...
void math_0065_3988506f_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_math_0065_3988506f *_wp_args,
    wp_args_math_0065_3988506f *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_data = _wp_args->data;
    ...
    wp::adj_mul(var_2, var_4, adj_2, adj_4, adj_5);
    // adj: output[i] = wp.sin(val * 3.14159)                                                 <L 9>
    ...
    // adj: i = wp.tid()                                                                      <L 7>
    // adj: def math_0065(data: wp.array(dtype=float),                                        <L 4>
    return;
}
...
WP_API void math_0065_3988506f_cpu_forward(
    wp::launch_bounds_t dim,
    wp_args_math_0065_3988506f *_wp_args)
{
    ...
    {
        math_0065_3988506f_cpu_kernel_forward(dim, task_index, _wp_args);
    }
}
...
WP_API void math_0065_3988506f_cpu_backward(
    wp::launch_bounds_t dim,
    wp_args_math_0065_3988506f *_wp_args,
    wp_args_math_0065_3988506f *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim.size; ++task_index)
    {
        math_0065_3988506f_cpu_kernel_backward(dim, task_index, _wp_args, _wp_adj_args);
    }
}
