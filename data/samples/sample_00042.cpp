...
struct wp_args_reduction_0042_4577b865 {
...
void reduction_0042_4577b865_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_reduction_0042_4577b865 *_wp_args)
{
    //---------
    // argument vars
    ...
    //---------
    // forward
    // def reduction_0042(data: wp.array(dtype=float),                                        <L 4>
    // tid = wp.tid()                                                                         <L 7>
    var_0 = builtin_tid1d();
...
void reduction_0042_4577b865_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_reduction_0042_4577b865 *_wp_args,
    wp_args_reduction_0042_4577b865 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_data = _wp_args->data;
    ...
    // adj: tid = wp.tid()                                                                    <L 7>
    // adj: def reduction_0042(data: wp.array(dtype=float),                                   <L 4>
    return;
}
...
WP_API void reduction_0042_4577b865_cpu_forward(
    wp::launch_bounds_t dim,
    wp_args_reduction_0042_4577b865 *_wp_args)
{
    ...
    {
        reduction_0042_4577b865_cpu_kernel_forward(dim, task_index, _wp_args);
    }
}
...
WP_API void reduction_0042_4577b865_cpu_backward(
    wp::launch_bounds_t dim,
    wp_args_reduction_0042_4577b865 *_wp_args,
    wp_args_reduction_0042_4577b865 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim.size; ++task_index)
    {
        reduction_0042_4577b865_cpu_kernel_backward(dim, task_index, _wp_args, _wp_adj_args);
    }
}
