...
struct wp_args_loop_0081_cdd6078a {
...
void loop_0081_cdd6078a_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_loop_0081_cdd6078a *_wp_args)
{
    //---------
    // argument vars
    ...
    //---------
    // forward
    // def loop_0081(matrix: wp.array(dtype=float, ndim=2),                                   <L 4>
    // i = wp.tid()                                                                           <L 8>
    var_0 = builtin_tid1d();
...
void loop_0081_cdd6078a_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_loop_0081_cdd6078a *_wp_args,
    wp_args_loop_0081_cdd6078a *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_matrix = _wp_args->matrix;
    ...
    // adj: i = wp.tid()                                                                      <L 8>
    // adj: def loop_0081(matrix: wp.array(dtype=float, ndim=2),                              <L 4>
    return;
}
...
WP_API void loop_0081_cdd6078a_cpu_forward(
    wp::launch_bounds_t dim,
    wp_args_loop_0081_cdd6078a *_wp_args)
{
    ...
    {
        loop_0081_cdd6078a_cpu_kernel_forward(dim, task_index, _wp_args);
    }
}
...
WP_API void loop_0081_cdd6078a_cpu_backward(
    wp::launch_bounds_t dim,
    wp_args_loop_0081_cdd6078a *_wp_args,
    wp_args_loop_0081_cdd6078a *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim.size; ++task_index)
    {
        loop_0081_cdd6078a_cpu_kernel_backward(dim, task_index, _wp_args, _wp_adj_args);
    }
}
