...
struct wp_args_arithmetic_0007_c45f3465 {
...
void arithmetic_0007_c45f3465_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_arithmetic_0007_c45f3465 *_wp_args)
{
    //---------
    // argument vars
...
void arithmetic_0007_c45f3465_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_arithmetic_0007_c45f3465 *_wp_args,
    wp_args_arithmetic_0007_c45f3465 *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_a = _wp_args->a;
...
WP_API void arithmetic_0007_c45f3465_cpu_forward(
    wp::launch_bounds_t dim,
    wp_args_arithmetic_0007_c45f3465 *_wp_args)
{
    ...
    {
        arithmetic_0007_c45f3465_cpu_kernel_forward(dim, task_index, _wp_args);
    }
}
...
WP_API void arithmetic_0007_c45f3465_cpu_backward(
    wp::launch_bounds_t dim,
    wp_args_arithmetic_0007_c45f3465 *_wp_args,
    wp_args_arithmetic_0007_c45f3465 *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim.size; ++task_index)
    {
        arithmetic_0007_c45f3465_cpu_kernel_backward(dim, task_index, _wp_args, _wp_adj_args);
    }
}
