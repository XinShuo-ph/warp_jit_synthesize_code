...
struct wp_args_math_0008_5589d5bc {
...
void math_0008_5589d5bc_cpu_kernel_forward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_math_0008_5589d5bc *_wp_args)
{
    //---------
    // argument vars
...
void math_0008_5589d5bc_cpu_kernel_backward(
    wp::launch_bounds_t dim,
    size_t task_index,
    wp_args_math_0008_5589d5bc *_wp_args,
    wp_args_math_0008_5589d5bc *_wp_adj_args)
{
    //---------
    // argument vars
    wp::array_t<wp::float32> var_data = _wp_args->data;
...
WP_API void math_0008_5589d5bc_cpu_forward(
    wp::launch_bounds_t dim,
    wp_args_math_0008_5589d5bc *_wp_args)
{
    ...
    {
        math_0008_5589d5bc_cpu_kernel_forward(dim, task_index, _wp_args);
    }
}
...
WP_API void math_0008_5589d5bc_cpu_backward(
    wp::launch_bounds_t dim,
    wp_args_math_0008_5589d5bc *_wp_args,
    wp_args_math_0008_5589d5bc *_wp_adj_args)
{
    ...
    for (size_t task_index = 0; task_index < dim.size; ++task_index)
    {
        math_0008_5589d5bc_cpu_kernel_backward(dim, task_index, _wp_args, _wp_adj_args);
    }
}
