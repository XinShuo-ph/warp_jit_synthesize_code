#!/usr/bin/env python3
"""
CUDA Code Production Script
Target: 200MB of Python→CUDA IR training data

Adapted from CPU version to use device="cuda"
Generates ~69,000 samples at average 2.98 KB/sample
"""
import os
import sys
import json
...
from cuda_batch_generator import generate_batch
...
def main():
    ...
    TARGET_MB = 200
    AVG_FILE_SIZE_KB = 2.98  # Based on CPU generation results
    ...
    output_dir = Path("/workspace/production/cuda_code")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    print("=" * 70)
    print("CUDA CODE PRODUCTION - 200MB TARGET")
    print("=" * 70)
    ...
    print()
    print("NOTE: This will generate CUDA IR code (device='cuda')")
    print("      GPU is not required - code generation happens on CPU")
    print()
    ...
    print()
    print("✓ CUDA code production complete!")
