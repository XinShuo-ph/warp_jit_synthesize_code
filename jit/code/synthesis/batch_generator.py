...
def init_worker():
    ...
    # JAX doesn't need explicit init, but we can configure flags here if needed.
    pass
        ...
        try:
            ...
            if hasattr(module, kernel_name):
                ...
                for name in dir(module):
                    ...
                    if hasattr(obj, 'lower') and hasattr(obj, 'as_lower'):
                         func = obj
                         kernel_name = name
                         break
            ...
            if func is None:
                raise ValueError("No JAX function found")
            ...
            result = {
                ...
                "cpp": ir.hlo_code,  # Mapping HLO to cpp field
                "cuda": ir.hlo_code, # Mapping HLO to cuda field
