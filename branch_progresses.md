...
## Overview
16 branches worked on Python→IR code synthesis for LLM training data (legacy implementation). This track migrates the project to **JAX** and extracts **JAXPR + compiler IR** (e.g. XLA/StableHLO/MLIR).

## Milestone Reference
- **M1**: Environment setup, run JAX examples
- **M2**: IR extraction mechanism (jaxpr + compiler IR)
- **M3**: Numerics deep dive, Poisson solver
...
├── notes/                # ir_format.md, data_stats.md
